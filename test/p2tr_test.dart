...
void main() {
  group('TestCreateP2trWithSingleTapScript', () {
    ...
    setUp(() {
      ...
      trScriptP2pk1 = Script(
        script: [pubkeyTrScript1.toXOnlyHex(), BitcoinOpcode.opCheckSig],
      );
      ...
      txOut2 = TxOutput(
        ...
        scriptPubKey: toAddress2.toScriptPubKey(),
      );
    ...
    test('address_with_script_path', () {
      ...
      expect(
        toAddress.toAddress(BitcoinNetwork.testnet),
        toTaprootScriptAddress1,
      );
    });
    ...
    test('spend_key_path2', () {
      var tx = BtcTransaction(inputs: [txIn2], outputs: [txOut2]);
      ...
      final signatur = fromPriv2.signBip340(
        txDigit,
        treeScript: TaprootLeaf(script: trScriptP2pk1),
        sighash: signHash,
      );
    ...
    test('spend_script_path2', () {
      var tx = BtcTransaction(outputs: [txOut2], inputs: [txIn2]);
      ...
      final sig = privkeyTrScript1.signBip340(
        digit,
  ...
  group('TestCreateP2trWithTwoTapScripts', () {
    ...
    late final trScriptP2pkA = Script(
      script: [pubkeyTrScriptA.toXOnlyHex(), BitcoinOpcode.opCheckSig],
    );
    ...
    late final trScriptP2pkB = Script(
      script: [pubkeyTrScriptB.toXOnlyHex(), BitcoinOpcode.opCheckSig],
    );
    ...
    late final txOut = TxOutput(
      amount: BigInt.from(3000),
      scriptPubKey: toAddress.toScriptPubKey(),
    );
    ...
    test('test_spend_script_path_A_from_AB', () {
      var tx = BtcTransaction(inputs: [txIn], outputs: [txOut]);
      ...
      final sign = privkeyTrScriptA.signBip340(txDigit, tweak: false);
      final controlBlock = TaprootControlBlock.generate(
  ...
  group('TestCreateP2trWithThreeTapScripts', () {
    ...
    final trScriptP2pkC = Script(
      script: [pubkeyTrScriptC.toXOnlyHex(), BitcoinOpcode.opCheckSig],
    );
