...
void main() {
  group('P2Sh', () {
    ...
    final p2pkRedeemScript = Script(
      script: [p2pkSk.getPublic().toHex(), BitcoinOpcode.opCheckSig],
    );
    final txout = TxOutput(
      amount: BigInt.from(9000000),
      scriptPubKey:
          P2shAddress.fromScript(
            script: p2pkRedeemScript,
    ...
    final txinSpend = TxInput(
      txId: '7db363d5a7fabb64ccce154e906588f1936f34481223ea8c1f2c935b0a0c945b',
      txIndex: 0,
    );
    ...
    final txout2 = TxOutput(
      ...
      scriptPubKey: toAddr.toScriptPubKey(),
    );
    ...
    final seq = Sequence(
      seqType: BitcoinOpCodeConst.typeRelativeTimelock,
      value: 200,
    );
