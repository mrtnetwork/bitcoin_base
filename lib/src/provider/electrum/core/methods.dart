...
class ElectrumRequestMethods {
  ...
  static const ElectrumRequestMethods serverAddPeer = ElectrumRequestMethods._(
    'server.add_peer',
  );
  ...
  static const ElectrumRequestMethods listunspent = ElectrumRequestMethods._(
    'blockchain.scripthash.listunspent',
  );

  /// Return the confirmed and unconfirmed balances of a script hash.
  static const ElectrumRequestMethods getBalance = ElectrumRequestMethods._(
    'blockchain.scripthash.get_balance',
  );

  /// Return a raw transaction.
  static const ElectrumRequestMethods getTransaction = ElectrumRequestMethods._(
    'blockchain.transaction.get',
  );

  /// Return the merkle branch to a confirmed transaction given its hash and height.
  static const ElectrumRequestMethods getMerkle = ElectrumRequestMethods._(
    'blockchain.transaction.get_merkle',
  );

  /// Return a transaction hash and optionally a merkle proof, given a block height and a position in the block.
  static const ElectrumRequestMethods idFromPos = ElectrumRequestMethods._(
  ...
  static const ElectrumRequestMethods blockHeader = ElectrumRequestMethods._(
    'blockchain.block.header',
  );

  /// Return a concatenated chunk of block headers from the main chain.
  static const ElectrumRequestMethods blockHeaders = ElectrumRequestMethods._(
  ...
  static const ElectrumRequestMethods estimateFee = ElectrumRequestMethods._(
    'blockchain.estimatefee',
  );

  /// Return the confirmed and unconfirmed history of a script hash.
  static const ElectrumRequestMethods getHistory = ElectrumRequestMethods._(
    'blockchain.scripthash.get_history',
  );

  /// Return the unconfirmed transactions of a script hash.
  static const ElectrumRequestMethods getMempool = ElectrumRequestMethods._(
    'blockchain.scripthash.get_mempool',
  );

  /// Broadcast a transaction to the network.
  static const ElectrumRequestMethods broadCast = ElectrumRequestMethods._(
    'blockchain.transaction.broadcast',
  );

  /// Return a banner to be shown in the Electrum console.
  static const ElectrumRequestMethods serverBanner = ElectrumRequestMethods._(
    'server.banner',
  );

  /// Return a list of features and services supported by the server.
  static const ElectrumRequestMethods serverFeatures = ElectrumRequestMethods._(
    'server.features',
  );
  ...
  static const ElectrumRequestMethods ping = ElectrumRequestMethods._(
    'server.ping',
  );

  /// Identify the client to the server and negotiate the protocol version. Only the first server.version() message is accepted.
  static const ElectrumRequestMethods version = ElectrumRequestMethods._(
    'server.version',
  );
  ...
  static const ElectrumRequestMethods relayFee = ElectrumRequestMethods._(
    'blockchain.relayfee',
  );
  ...
  static const ElectrumRequestMethods masternodeList = ElectrumRequestMethods._(
    'masternode.list',
  );

  /// Returns a diff between two deterministic masternode lists. The result also contains proof data.
  static const ElectrumRequestMethods protxDiff = ElectrumRequestMethods._(
    'protx.diff',
  );

  /// Returns detailed information about a deterministic masternode.
  static const ElectrumRequestMethods protxInfo = ElectrumRequestMethods._(
    'protx.info',
  );

  /// Returns a name resolution proof, suitable for low-latency (single round-trip) resolution.
  static const ElectrumRequestMethods getValueProof = ElectrumRequestMethods._(
