...
class MempoolVin {
  ...
  factory MempoolVin.fromJson(Map<String, dynamic> json) {
    return MempoolVin(
      ...
      prevOut: json.valueTo<MempoolPrevOut?, Map<String, dynamic>>(
        key: "prevout",
        parse: MempoolPrevOut.fromJson,
      ),
      scriptSig: json.valueAs("scriptsig"),
      scriptSigAsm: json.valueAs("scriptsig_asm"),
      witness: json.valueAsList<List<String>?>("witness") ?? [],
      isCoinbase: json.valueAs("is_coinbase"),
...
class MempoolTransaction {
  ...
  bool isCoinbse() => vin.length == 1 && vin.first.isCoinbase;
}
...
extension ExtMempoolUtxo on List<MempolUtxo> {
