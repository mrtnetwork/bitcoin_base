...
class BlockCypherRequestDetails extends BitcoinRequestDetails {
  final String method;
  const BlockCypherRequestDetails({
  ...
  }) : super(api: BitcoinProviderApi.blockCypher);
  factory BlockCypherRequestDetails.deserialize({
    List<int>? bytes,
    CborObject? object,
  }) {
    ...
    return BlockCypherRequestDetails(
      headers: values
  ...
  BlockCypherRequestDetails copyWith({
    int? requestID,
...
abstract class BlockCypherRequest<RESULT, RESPONSE>
    extends BaseServiceRequest<RESULT, RESPONSE, BlockCypherRequestDetails> {
  const BlockCypherRequest();
  abstract final BlockCypherRequestMethods method;
  List<String> get parameters => [];
  Map<String, String?> get queryParameters => {};
  List<int>? get body => null;

  @override
  BlockCypherRequestDetails buildRequest(int requestID) {
